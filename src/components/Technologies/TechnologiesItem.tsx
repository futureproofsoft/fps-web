...
const technologiesClassName =
  'sm:my-3 mb:my-1 flex sm:items-center sm:justify-center  2xl:my-6 transition duration-300 3xl:hover:scale-125 lg:hover:scale-[1.15]';

export const TechnologiesItem = () => {
  return (
    <>
      <div className='mb:hidden lg:block'>
        <div className=' mb:px-12  inline-flex h-full  w-full flex-nowrap items-center gap-10 overflow-x-auto  sm:grid sm:grid-cols-4 sm:overflow-hidden'>
          <div className={technologiesClassName}>
            <HtmlSvg className='mb:w-[80px] sm:w-2/5' />
          </div>
          <div className={technologiesClassName}>
            <CssSvg className='mb:w-[80px] sm:w-2/5' />
          </div>
          <div className={technologiesClassName}>
            <JavaSricptSvg className='mb:w-[60px] sm:w-[30%]' />
          </div>
          <div className={technologiesClassName}>
            <TypeSricptSvg className='mb:w-[60px] sm:w-[30%]' />
          </div>
          <div className={technologiesClassName}>
      ...
      <div className='mb:block lg:hidden'>
