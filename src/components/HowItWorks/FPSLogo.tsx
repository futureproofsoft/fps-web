...
export const FPSLogo: React.FC<{
  outsideFillColor?: boolean;
  insideFillColor?: boolean;
  ballFillColor?: boolean;
}> = ({ outsideFillColor, insideFillColor, ballFillColor }) => {
  return (
    <svg
    ...
    >
      <defs>
        <style>
          ...
          {`.fps-cls-2 {
                 fill: url(#fps-linear-gradient);
                 transition: opacity 0.5s;
                 ${insideFillColor ? '' : 'opacity: 0.1'}
            }`}

          {`.fps-cls-3 {
                 fill: url(#fps-linear-gradient-2);
                 transition: opacity 0.5s;
                 ${insideFillColor ? '' : 'opacity: 0.1'}
            }`}

          {`.fps-cls-4 {
                 fill: url(#fps-linear-gradient-3);
                 transition: opacity 0.5s;
                 ${insideFillColor ? '' : 'opacity: 0.1'}
            }`}

          {`.fps-cls-5 {
                 fill: url(#fps-linear-gradient-4);
                 transition: opacity 0.5s;
                 ${ballFillColor ? '' : 'opacity: 0.1'}
            }`}
          ...
          {`.fps-cls-8 {
                 fill: url(#fps-linear-gradient-5);
                 transition: opacity 0.5s;
                 ${outsideFillColor ? '' : 'opacity: 0.1'}
            }`}
        </style>
        <linearGradient
          id='fps-linear-gradient'
          x1='231.63'
          y1='705.41'
          x2='483.32'
          y2='705.41'
        ...
        >
          ...
          <stop offset='0.22' stopColor='#1073a3' />
          <stop offset='0.35' stopColor='#095f95' />
          <stop offset='0.51' stopColor='#04518b' />
          <stop offset='0.69' stopColor='#014985' />
          <stop offset='1' stopColor='#004683' />
        </linearGradient>
        <linearGradient
          id='fps-linear-gradient-2'
          x1='371.26'
          y1='153.71'
          x2='738.04'
          y2='365.47'
        ...
        >
          <stop offset='0' stopColor='#22a8c9' />
          <stop offset='1' stopColor='#003f83' />
        </linearGradient>
        <linearGradient
          id='fps-linear-gradient-3'
          x1='50.71'
          y1='668.87'
          x2='255.42'
          y2='704.97'
          gradientUnits='userSpaceOnUse'
        >
          <stop offset='0' stopColor='#004683' />
          <stop offset='0.29' stopColor='#0d6d9f' />
          <stop offset='0.58' stopColor='#198db6' />
          <stop offset='0.83' stopColor='#20a1c4' />
          <stop offset='1' stopColor='#22a8c9' />
        </linearGradient>
        <linearGradient
          id='fps-linear-gradient-4'
          x1='449.02'
          y1='722.68'
          x2='550.29'
          y2='444.45'
          gradientUnits='userSpaceOnUse'
        >
          <stop offset='0' stopColor='#64c9b9' />
          <stop offset='0.44' stopColor='#9bd9c9' />
          <stop offset='0.81' stopColor='#c4e5d5' />
          <stop offset='1' stopColor='#d3eada' />
        </linearGradient>
        ...
        <radialGradient
          id='radial-gradient ball'
          cx='514.08'
          cy='480.54'
          r='132.5'
          gradientUnits='userSpaceOnUse'
        >
          <stop offset='0' stopColor='#fdfacc' />
          <stop offset='0.17' stopColor='#fdfacc' stopOpacity='0.78' />
          <stop offset='0.39' stopColor='#fdfacc' stopOpacity='0.51' />
          <stop offset='0.6' stopColor='#fdfacc' stopOpacity='0.29' />
          <stop offset='0.78' stopColor='#fdfacc' stopOpacity='0.13' />
          <stop offset='0.91' stopColor='#fdfacc' stopOpacity='0.04' />
          <stop offset='1' stopColor='#fdfacc' stopOpacity='0' />
        </radialGradient>
        <linearGradient
          id='fps-linear-gradient-5'
          x1='33.36'
          y1='469.71'
          x2='914.12'
          y2='978.21'
        ...
        >
          <stop offset='0' stopColor='#004683' />
          <stop offset='0.08' stopColor='#06578f' />
          <stop offset='0.37' stopColor='#1a91b9' />
          <stop offset='0.52' stopColor='#22a8c9' />
          <stop offset='0.6' stopColor='#20a2c4' />
          <stop offset='0.71' stopColor='#198fb7' />
          <stop offset='0.84' stopColor='#0f72a2' />
          <stop offset='0.99' stopColor='#014985' />
          <stop offset='1' stopColor='#004683' />
        </linearGradient>
      </defs>
      <title>symbol</title>
      <g id='Layer_2' data-name='Layer 2'>
        <g id='Layer_1-2' data-name='Layer 1'>
          ...
          />
          <circle className='fps-cls-5' cx='500.58' cy='581.04' r='148' />
          <g className='fps-cls-6'>
            <circle className='fps-cls-7' cx='514.08' cy='480.54' r='132.5' />
          </g>
          <path
            className='fps-cls-8'
            id='outside'
