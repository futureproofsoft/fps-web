...
export const WhoWeAre = () => {
  return (
    <section id='about-us' className='3xl:pt-36  md:pt-14 lg:pt-20 xl:pt-28'>
      <h5 className='border-greenText 3xl:text-2xl border-s-4 px-3 font-bold tracking-[4.8px] md:text-sm lg:text-base xl:text-lg'>
        WHO WE ARE
      </h5>
      <div className='flex justify-between md:flex-col lg:flex-row'>
        <h2 className='3xl:text-6xl lg:pb font-bold tracking-normal md:pb-5 md:pt-2 md:text-2xl  md:leading-none lg:pt-5 lg:text-[30px] xl:text-[38px] 2xl:pb-20 2xl:pt-7 2xl:text-[44px]'>
          Your <span className='text-greenText'>digital partner</span> to create
          <br className='md:hidden lg:flex' /> a{' '}
          <span className='text-greenText'>recognizable</span> brand.
        </h2>
        <p className='3xl:text-xl font-normal md:text-xs lg:w-5/12 xl:text-sm  2xl:text-base'>
