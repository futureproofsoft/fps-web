...
export const WhoWeAre = () => {
  return (
    <section id='about-us' className='3xl:pt-36  sm:pt-14 lg:pt-20 xl:pt-28'>
      ...
      <div className='flex justify-between sm:flex-col lg:flex-row'>
        <h2 className='3xl:text-6xl lg:pb font-bold tracking-normal sm:pb-5 sm:pt-2 sm:text-2xl  sm:leading-none lg:pt-5 lg:text-[30px] xl:text-[38px] 2xl:pb-20 2xl:pt-7 2xl:text-[44px]'>
