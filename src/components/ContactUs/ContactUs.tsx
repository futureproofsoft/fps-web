    ...
    <section id='contact-us' className='3xl:py-36 2xl:py-28'>
      <div className='grid grid-cols-[1.6fr,1fr,1fr]  '>
        <div className='flex flex-col justify-between  pr-48'>
          ...
          <p className='3xl:text-xl 3xl:leading-6 2xl:text-sm 2xl:leading-4'>
          ...
          <div className='flex flex-col gap-[14px]'>
            <a
              ...
              className='3xl:text-xl flex gap-3 2xl:text-lg'
            >
        ...
        <div className=' colorContact grid grid-rows-3 justify-between rounded-bl-3xl rounded-tl-3xl border-2 border-solid border-transparent p-14'>
          <div className='flex items-start justify-center'>
            <h2 className='3xl:text-5xl font-bold leading-[64px] 2xl:text-4xl'>
              Got a project? Let's talk!
            </h2>
          </div>
          <div className='flex items-center '>
            <p className='3xl:text-xl 2xl:text-sm'>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt ut labore et dolore magna.
            </p>
          </div>
          <div className='flex items-end justify-center'>
            <button className='3xl:text-base rounded-[32px] border-[1.5px] px-12 py-4 font-bold 2xl:text-sm '>
