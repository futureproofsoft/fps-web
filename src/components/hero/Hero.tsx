...
export const Hero = () => {
  return (
    <section className='3xl:py-36 flex items-center justify-between lg:py-20'>
      <div className='animation-slide-left w-1/2'>
        ...
        <p className='border-greenText 3xl:text-2xl border-s-4 px-3 lg:text-sm lg:leading-[16px]  xl:text-base  xl:leading-[20px] 2xl:text-lg 2xl:leading-[30px] '>
